...
//  FavoriteBooks
//
//  Created by Saurabh Singh on 25/08/25.
//
...
class BookFormTableViewController: UITableViewController {
    ...
    @IBOutlet weak var BookLength: UITextField!
    ...
    @IBAction func SaveButton(_ sender: Any) {
        guard let title = Name.text,
        let author = AuthorName.text,
        let genre = GenreName.text,
        let length = BookLength.text else {return}
